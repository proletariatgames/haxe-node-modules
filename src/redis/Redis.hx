...
typedef RedisClient = {
  ...
  @:overload(function(k:String,max:Float,min:String,limit:String,offset:Int,count:Int,cb:MultiReply):Void {})
  @:overload(function(k:String,max:String,min:Float,limit:String,offset:Int,count:Int,cb:MultiReply):Void {})
